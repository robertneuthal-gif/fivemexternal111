...
static void ShowTableColumnsStatusFlags(ImGuiTableColumnFlags flags)
{
    ...
    ImGui::CheckboxFlags("_is_visible", &flags, ImGuiTableColumnFlags_is_visible);
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Columns flags"))
    {
        ...
        // We use a scrolling table to be able to showcase the difference between the _IsEnabled and _is_visible flags above,
