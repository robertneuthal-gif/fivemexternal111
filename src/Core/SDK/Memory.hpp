...
namespace core {
	...
	public:
		...
		uintptr_t name_module_base;
		uintptr_t glue_dll;

		uintptr_t citizen_resources;
		...
		uintptr_t PatternScanModule(std::vector<uint8_t> Pattern, int InstructionLength, uintptr_t ModuleBase, uintptr_t ModuleBaseSize);
